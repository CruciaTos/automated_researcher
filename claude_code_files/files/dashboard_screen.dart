...
class _DashboardScreenState extends ConsumerState<DashboardScreen>
  ...
  final List<_DepthOption> _depthOptions = const [
    _DepthOption(minutes: 5, label: 'Quick', sublabel: '~5 min', icon: Icons.flash_on_rounded),
    _DepthOption(minutes: 25, label: 'Standard', sublabel: '~25 min', icon: Icons.search_rounded),
    _DepthOption(minutes: 40, label: 'Deep', sublabel: '~40 min', icon: Icons.travel_explore_rounded),
  ];
            ...
            children: [
              ...
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: _isFocused ? AppColors.borderBright : AppColors.border,
                    width: 1,
                  ),
                ),
                child: TextField(
              ...
              const SizedBox(height: 10),
              Row(
                children: _depthOptions.map((option) {
                  final isSelected = _selectedDepth == option.minutes;
                  return Expanded(
                    child: Padding(
                      padding: EdgeInsets.only(
                        right: option.minutes != 40 ? 10 : 0,
                      ),
                      child: _DepthCard(
                        option: option,
                        isSelected: isSelected,
                        onTap: () =>
                            setState(() => _selectedDepth = option.minutes),
                      ),
                    ),
                  );
                }).toList(),

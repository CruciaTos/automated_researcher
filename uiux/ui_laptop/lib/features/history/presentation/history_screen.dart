          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              child: state.when(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          const Text('Unable to load your research history.',
                              style: TextStyle(
                                  fontSize: 13,
                ...
                data: (jobs) {
                  if (jobs.isEmpty) return _empty(context);
                        ...
                        return Padding(
                          ...
                          child: ResearchCard(
                            ...
                            onTap: () {
                              ...
                              } else if (_inProgress.contains(job.status)) {
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            const Text('No research yet',
                style: TextStyle(
                    ...
                    fontFamily: 'GeneralSans')),
            const SizedBox(height: 8),
            const Text('Your completed research jobs\nwill appear here.',

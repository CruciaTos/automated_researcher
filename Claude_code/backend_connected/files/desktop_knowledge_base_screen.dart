...
final _kbSelectedSrcProvider  =
    StateProvider<SourceDocument?>((ref) => null);
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                    child: _SourceList(jobsAsync: jobsAsync)),
              ],
            ),
          ),
        ),
          ...
          child: selectedId == null
              ? Center(
                  child: EmptyState(
                    ...
                    subtitle:
                        'Click on a document to preview its content.',
                  ),
                )
      ...
      child: Column(
        ...
        children: [
                ...
                : Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<int?>(
                        ...
                        onChanged: (v) {
                          ref
                              .read(_kbSelectedJobProvider
                                  .notifier)
                              .state = v;
                          ref
                              .read(_kbSelectedSrcProvider
                                  .notifier)
                              .state = null;
                        },
                      ),
          ...
          SizedBox(
            ...
            child: TextField(
              onChanged: (v) => ref
                  .read(_kbSearchProvider.notifier)
                  .state = v,
...
class _SourceList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final selectedJobId = ref.watch(_kbSelectedJobProvider);
    final query =
        ref.watch(_kbSearchProvider).toLowerCase();
          ...
          data: (sources) {
            ...
            return ListView.separated(
              ...
              separatorBuilder: (_, __) => const Divider(
                  height: 1, color: Dt.border),
              itemBuilder: (_, i) {
                final src      = filtered[i];
                final selected = ref
                        .watch(_kbSelectedSrcProvider)
                        ?.title ==
                    src.title;
                return _SourceTile(
                  source:     src,
                  isSelected: selected,
                  onTap: () => ref
                      .read(_kbSelectedSrcProvider.notifier)
                      .state = src,
                );
              },
            );
            ...
            children: [
              ...
              if (doc.url.isNotEmpty)
                TextButton.icon(
                  ...
                  icon: const Icon(
                      Icons.open_in_new_rounded, size: 13),

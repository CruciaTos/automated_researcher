        ...
        child: Column(
          ...
          children: [
            ...
            if (subtitle != null) ...[
              ...
              Text(subtitle!, style: Dt.bodySm, textAlign: TextAlign.center),
            ],
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 22,
            decoration: BoxDecoration(
              color: isDone ? Dt.successBg : (isActive ? Dt.primaryLight : Dt.bgMuted),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: isDone ? Dt.textSecondary : (isActive ? Dt.textPrimary : Dt.textMuted),
            ),
          ),
          if (isActive) ...[

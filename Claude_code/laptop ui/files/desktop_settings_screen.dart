...
class _DesktopSettingsScreenState
  ...
  final _backendCtrl = TextEditingController(text: 'http://localhost:8000');
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Configure your research workspace.', style: Dt.bodyMd),
            ...
            builder: (context, constraints) {
              if (constraints.maxWidth > 800) {
                return Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Expanded(child: _leftColumn(healthAsync)),
  ...
  Widget _leftColumn(AsyncValue<bool> healthAsync) => Column(
        children: [
          // Backend config card
          DesktopCard(
            child: Column(
              ...
              children: [
                _CardHeader(
                  ...
                  trailing: healthAsync.when(
                    data: (ok) => _StatusDot(connected: ok),
                    loading: () => const _StatusDot(connected: null),
                    error: (_, __) => const _StatusDot(connected: false),
                  ),
                ),
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      onChanged: (v) =>
                          setState(() => _modelName = v ?? _modelName),
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Models are served locally via Ollama. Ensure the '
                          'model is pulled before starting a research job.',
            ...
            child: Column(
              ...
              children: [
                ...
                _SwitchRow(
                  ...
                  value:    _emailUpdates,
                  onChange: (v) => setState(() => _emailUpdates = v),
                ),
                _SwitchRow(
                  label:    'Auto-delete jobs older than 3 days',
                  value:    _autoCleanup,
                  onChange: (v) => setState(() => _autoCleanup = v),
                ),
              ],
            ),
          ),
          ...
          DesktopCard(
            ...
            child: Column(
              ...
              children: [
                const Row(
                  children: [
                    Icon(Icons.warning_amber_rounded, size: 16, color: Dt.error),
                    SizedBox(width: 8),
                    Text('Danger Zone',
                        style: TextStyle(
                            fontSize: 14,
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 12, color: Dt.error),
                ),
                const SizedBox(height: 12),
                SizedBox(
                  height: 34,
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(color: Dt.error.withOpacity(0.4)),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(Dt.inputRadius),
                      ),
                    ),
                    child: const Text('Clear All Jobs & Reports',
  ...
  void _save() {
    // TODO: persist settings via a settings service
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(
          children: [
            SizedBox(width: 90, child: Text(label, style: Dt.bodySm)),
            Text(value,
                style: const TextStyle(
                    fontSize: 12,

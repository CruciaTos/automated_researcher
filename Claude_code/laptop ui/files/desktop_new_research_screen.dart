...
class _DesktopNewResearchScreenState
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.edit_outlined, size: 14, color: Dt.primary),
                        ),
                        const SizedBox(width: 10),
                        const Text('Research Topic', style: Dt.cardTitle),
                      ],
                    ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle:
                            const TextStyle(fontSize: 13, color: Dt.textMuted, height: 1.5),
                        filled: true,
                      ...
                      style: const TextStyle(fontSize: 14, color: Dt.textPrimary, height: 1.5),
                    ),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.timer_outlined, size: 14, color: Dt.info),
                        ),
                        const SizedBox(width: 10),
                        const Text('Research Depth', style: Dt.cardTitle),
                      ],
                    ),
                    const SizedBox(height: 16),
                    Row(
                      children: [
                        ...
                        _DepthTile(
                          ...
                          selected:    _depth == 25,
                          onTap:       () => setState(() => _depth = 25),
                        ),
                        const SizedBox(width: 12),
                        _DepthTile(
                          minutes:     40,
                          label:       'Deep',
                          description: 'Max sources, detailed analysis',
                          selected:    _depth == 40,
                          onTap:       () => setState(() => _depth = 40),
                        ),
                      ],
                    ),
                  ],
                ...
                child: Column(
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 10),
                            const Text('Advanced Options', style: Dt.cardTitle),
                            const Spacer(),
                            AnimatedRotation(
                    ...
                    AnimatedSize(
                      ...
                      child: _advanced
                          ? _AdvancedPanel(
                              includeWikipedia: _includeWikipedia,
                              includeArxiv:     _includeArxiv,
                              autoSummarize:    _autoSummarize,
                              onWikiChanged: (v) =>
                                  setState(() => _includeWikipedia = v),
                              onArxivChanged: (v) =>
                                  setState(() => _includeArxiv = v),
              ...
              if (creation.hasError) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Dt.errorBg,
                    borderRadius: BorderRadius.circular(Dt.inputRadius),
                    border: Border.all(color: Dt.error.withOpacity(0.3)),
                  ),
                  child: Row(
                    children: [
  ...
  Future<void> _submit(BuildContext context) async {
    ...
    await ref.read(jobCreationProvider.notifier).createJob(topic, _depth);
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: selected ? Dt.primary : Dt.textPrimary,
                  ),
                ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 11,
                    color: selected ? Dt.primary.withOpacity(0.7) : Dt.textMuted,
                    height: 1.4,
                  ),
                ),
              ],

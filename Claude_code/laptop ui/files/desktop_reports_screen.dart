              ...
              children: [
                ...
                Expanded(
                  child: jobsAsync.when(
                    ...
                    error: (e, _) => Center(
                        child: Text('Error: $e', style: Dt.bodySm)),
                    data: (jobs) {
          ...
          child: selectedId == null
              ? Center(
                  child: EmptyState(
                    ...
                    subtitle: 'Choose a completed report from the list.',
                  ),
                )
...
class _ListHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final count = jobsAsync.maybeWhen(
      data: (jobs) => jobs.where((j) => j.status == 'completed').length,
      orElse: () => 0,
    );
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                height: 30,
                decoration: BoxDecoration(
                  color: widget.isSelected ? Dt.primary : Dt.bgMuted,
                  borderRadius: BorderRadius.circular(7),
                ),
                child: Icon(
                  Icons.description_outlined,
                  size: 14,
                  color: widget.isSelected ? Colors.white : Dt.textMuted,
                ),
              ),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return reportAsync.when(
      loading: () => const Center(
          child: CircularProgressIndicator(strokeWidth: 2)),
      error:   (e, _) =>
          Center(child: Text('Failed to load report: $e', style: Dt.bodyMd)),
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(text, style: Dt.bodyMd.copyWith(fontSize: 14, height: 1.7)),
                ],
              ),
            ),
          ),
...
class _OutlinePanel extends ConsumerWidget {
      ...
      children: [
        ...
        Expanded(
          child: reportAsync.when(
            ...
            data:    (report) {
              // Parse rough outline from report text
              final sections = _extractSections(report.report ?? '');
              if (sections.isEmpty) {
                return Padding(
                  padding: const EdgeInsets.all(16),
                  child: Text('No outline available.', style: Dt.bodySm),
                );
              }
  ...
  List<String> _extractSections(String text) {
    // Heuristic: lines that start with a number or capital word and end
    // with a newline paragraph break.
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              ...
              children: [
                Icon(widget.icon, size: 14, color: Dt.textSecondary),
